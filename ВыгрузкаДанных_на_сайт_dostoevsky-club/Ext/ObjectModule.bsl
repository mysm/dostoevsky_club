...
Функция Выгрузить() Экспорт
	...
	Попытка
		...
		Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
		               ...
		               |	ЕСТЬNULL(Значение19.Значение, false) КАК is_active,
		               |	ЕСТЬNULL(Значение20.Значение, false) КАК is_available,
			...
			Пока Выборка.Следующий() Цикл
				...
				Если ПараметрыFTP.ВыгружатьНаFTP Тогда
					...
					Если МассивДанныхЗадания.Количество() = КоличествоДанныхДляЗадания Тогда
						...
						ЗаписатьВЖурнал(СтрШаблон("Отправка FTP. Задание (%1). Статус задания %2.", ФЗ.ИдентификаторЗадания, ФЗ.Статус), Настройки);
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Версия = "2.73";
